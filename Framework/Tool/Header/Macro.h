...
#define NULL_CHECK_RETURN_VOID( _ptr)	\
{if( _ptr == 0){__asm { int 3 };return;}}
...
#define FAILED_CHECK_VOID(_hr)	if( ((HRESULT)(_hr)) < 0 )	\
{ __asm { int 3 }; return;}
...
#define FAILED_CHECK_RETURN_VOID(_hr, _return)	if( ((HRESULT)(_hr)) < 0 )		\
{ ::MessageBoxW(NULL, L"Failed", L"System Error",MB_OK); __asm { int 3 }; return;}
