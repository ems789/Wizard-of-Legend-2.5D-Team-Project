...
class CFireHeel : public Engine::CGameObject
{
private:
	explicit CFireHeel(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CFireHeel();
...
public:
	static CFireHeel* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& vInitialPos, const _vec3& vDir, const _float& fSpeed, const _float& fLifeTime);
