...
CLightning* CLightning::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& vInitialPos, const _vec3& vDir, const _float& fMaxFrame, const _float& fFrameSpeed,const _float& fLifeTime, const _float& fRadius /*= 1.f*/, const _float& fAttackDelay /*= 0.5f*/, const _tchar* pCollisionTag /*= L"Player_Bullet"*/)
{
