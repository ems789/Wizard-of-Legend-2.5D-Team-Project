#ifndef  SkeletonMinion_h__
#define  SkeletonMinion_h__
...
class CSkeletonMinion : public Engine::CGameObject
{
private:
	enum SKELETONMINION_STATE {SK_IDLE, SK_ATTACK, SK_RUN, SK_DEAD, SK_END};
	enum SKELETONMINION_DIR	  {SD_UP, SD_DOWN, SD_LEFT, SD_RIGHT, SD_END};

private:
	explicit CSkeletonMinion(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CSkeletonMinion();
...
private:
	...
	void	Fitting_Scale_With_Texture(CSkeletonMinion::SKELETONMINION_STATE eState);
	void	Fitting_Scale_With_Texture(CSkeletonMinion::SKELETONMINION_STATE eState, _ulong dwIndex);
...
public:
	static void SkeletonMinion_Hit_Effect();
...
private:
	...
	CSkeletonMinion::SKELETONMINION_STATE	m_eCurState = CSkeletonMinion::SK_END;
	CSkeletonMinion::SKELETONMINION_STATE	m_ePreState = CSkeletonMinion::SK_END;
	CSkeletonMinion::SKELETONMINION_DIR	    m_eCurDir = CSkeletonMinion::SD_END;

	_float	m_fSpeed = 2.f;

public:
	static CSkeletonMinion* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* pPos);
