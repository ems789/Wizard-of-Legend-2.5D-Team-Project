#ifndef LightningChainDash_h__
#define LightningChainDash_h__
...
class CLightningChainDash : public Engine::CGameObject
{
public:
	CLightningChainDash(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CLightningChainDash();
...
public:
	static CLightningChainDash* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3 & vInitialPos, _float fAngle, const _float& fLifeTime);
