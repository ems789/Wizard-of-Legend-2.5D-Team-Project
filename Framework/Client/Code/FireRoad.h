...
class CFireRoad : public Engine::CGameObject
{
private:
	explicit CFireRoad(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CFireRoad();
...
public:
	static CFireRoad* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& vInitialPos, const _float& fLifeTime);
