...
class CWindSpin : public Engine::CGameObject
{
private:
	explicit CWindSpin(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CWindSpin();
...
public:
	static CWindSpin* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& vInitialPos, const _float& fLifeTime,  const _int& iAttack = 10, const _float& fSize = 0.01f, const _tchar* pCollisionTag = L"MonsterAttack", const _float& fRadius = 1.f);
private:
