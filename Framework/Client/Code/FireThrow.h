#ifndef FireThrow_h__
#define FireThrow_h__
...
class CFireThrow : public Engine::CGameObject
{
private:
	explicit CFireThrow(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CFireThrow();
...
public:
	static CFireThrow* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& vInitialPos, const _vec3& vTargetPos, const _vec3& vBentDir, const _float& fBentDecel, const _float& fSpeed);
