...
CThunderFall::CThunderFall(LPDIRECT3DDEVICE9 pGraphicDev)
	: CSkill(pGraphicDev)
{

}

CThunderFall::~CThunderFall()
{

}

HRESULT CThunderFall::Ready_Skill()
{
	m_fCoolTime = 3.f;

	Engine::Ready_Timer(L"ThunderFall_CoolTime");
	Engine::Set_TimeDelta(L"ThunderFall_CoolTime");

	return S_OK;
}

_int CThunderFall::Use_Skill(const _float& fTimeDelta)
{
	_float fCumulativeTime = Engine::Get_CummulativeTime(L"ThunderFall_CoolTime");
	if (m_bFirstShot)
	{
	...
	pCollider->Add_Hit_Effect(ThunderFall_Hit_Func);
...
_int CThunderFall::Use_Skill(const _float & fTimeDelta, const _vec3 * pPos, const _vec3 * pDir)
{
	_float fCumulativeTime = Engine::Get_CummulativeTime(L"ThunderFall_CoolTime");
	if (m_bFirstShot)
	{
...
_int CThunderFall::Use_UpgradedSkill(const _float & fTimeDelta)
{
	_float fCumulativeTime = Engine::Get_CummulativeTime(L"ThunderFall_CoolTime");
	if (m_bFirstShot)
	{
...
_int CThunderFall::Use_UpgradedSkill(const _float & fTimeDelta, const _vec3 * pPos, const _vec3 * pDir)
{
	_float fCumulativeTime = Engine::Get_CummulativeTime(L"ThunderFall_CoolTime");
	if (m_bFirstShot)
	{
...
void CThunderFall::ThunderFall_Hit_Func()
{
	Engine::PlaySound_(L"ImpactPhysicalLight.wav", CSoundMgr::EFFECT);
}

CThunderFall* CThunderFall::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CThunderFall*	pInstance = new CThunderFall(pGraphicDev);
