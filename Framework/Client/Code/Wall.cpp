...
void CWall::Set_HasWall(bool bHasLeftWall, bool bHasTopWall, bool bHasRightWall, bool bHasBottomWall)
{
...
CWall* CWall::Create(LPDIRECT3DDEVICE9 pGraphicDev, bool bHasLeftWall, bool bHasTopWall, bool bHasRightWall, bool bHasBottomWall)
{
	...
	pInstance->Set_HasWall(bHasLeftWall, bHasTopWall, bHasRightWall, bHasBottomWall);
