...
class CAqua : public Engine::CGameObject
{
private:
	explicit CAqua(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CAqua();
...
public:
	static CAqua* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& vInitialPos, const _vec3& vAngle, const _float& fSpeed, const _float& fMaxFrame, const _float& fFrameSpeed, const _float& fScale);
