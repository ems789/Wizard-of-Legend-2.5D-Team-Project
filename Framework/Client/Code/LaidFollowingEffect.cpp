...
CLaidFollowingEffect::CLaidFollowingEffect(LPDIRECT3DDEVICE9 pGraphicDev)
	: CEffect(pGraphicDev)
{

}

CLaidFollowingEffect::~CLaidFollowingEffect()
{

}

_int CLaidFollowingEffect::Update_GameObject(const _float& fTimeDelta)
{
	//Turn_To_Camera_Look();
...
void CLaidFollowingEffect::Render_GameObject()
{
...
HRESULT CLaidFollowingEffect::Ready_GameObject(const _tchar * pTextureTag)
{
...
void CLaidFollowingEffect::LifeTimer(const _float & fTimeDelta)
{
	if (m_fLifeTime <= 0.f)
		return;
...
void CLaidFollowingEffect::Animation(const _float& fTimeDelta)
{
...
void CLaidFollowingEffect::Update_Scale()
{
...
void CLaidFollowingEffect::Turn_To_Camera_Look()
{
...
CLaidFollowingEffect* CLaidFollowingEffect::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _tchar* pTextureTag, const _tchar* pEffectTag, const _float& fMaxFrame, const _float& fFrameSpeed,
	const _float& fScale, const _vec3* pPos, const _vec3* pTargetPos, const _float& fAngleY, _bool bAnimRepeat, _float fLifeTime)
{
	CLaidFollowingEffect* pInstance = new CLaidFollowingEffect(pGraphicDev);
...
void CLaidFollowingEffect::Free()
{
	CEffect::Free();
}
