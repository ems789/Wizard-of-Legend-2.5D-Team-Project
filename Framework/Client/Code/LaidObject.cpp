...
CLaidObject::CLaidObject(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CLaidObject::~CLaidObject()
{

}

_int CLaidObject::Update_GameObject(const _float& fTimeDelta)
{
	//Turn_To_Camera_Look();
...
void CLaidObject::Render_GameObject()
{
...
HRESULT CLaidObject::Add_Component(const _tchar * pTextureTag)
{
...
HRESULT CLaidObject::Ready_GameObject(const _tchar * pTextureTag)
{
...
void CLaidObject::LifeTimer(const _float & fTimeDelta)
{
	if (m_fLifeTime <= 0.f)
		return;
...
void CLaidObject::Animation(const _float& fTimeDelta)
{
...
CLaidObject* CLaidObject::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _tchar* pTextureTag, const _float& fMaxFrame, const _float& fFrameSpeed,
	const _float& fScale, const _vec3* pPos, const _float& fAngleY, _bool bAnimRepeat, _float fLifeTime)
{
	CLaidObject* pInstance = new CLaidObject(pGraphicDev);
