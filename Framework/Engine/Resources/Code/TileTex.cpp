...
Engine::CTileTex::CTileTex(LPDIRECT3DDEVICE9 pGraphicDev)
...
Engine::CTileTex::CTileTex(const CTileTex& rhs)
	: CVIBuffer(rhs)
	, m_pPos(rhs.m_pPos)
	, m_bClone(true)
{
...
Engine::CTileTex::~CTileTex(void)
{

}

HRESULT Engine::CTileTex::Ready_Buffer(const _ulong dwVtxItv)
{
...
Engine::CResources* Engine::CTileTex::Clone(void)
{
	return new CTileTex(*this);
}

Engine::CTileTex* Engine::CTileTex::Create(LPDIRECT3DDEVICE9 pGraphicDev,
...
void Engine::CTileTex::Free(void)
{
	CVIBuffer::Free();
