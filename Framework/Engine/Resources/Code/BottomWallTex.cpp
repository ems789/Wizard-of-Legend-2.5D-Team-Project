...
Engine::CBottomWallTex::CBottomWallTex(LPDIRECT3DDEVICE9 pGraphicDev)
...
Engine::CBottomWallTex::CBottomWallTex(const CBottomWallTex& rhs)
	: CVIBuffer(rhs)
	, m_pPos(rhs.m_pPos)
	, m_bClone(true)
{
...
Engine::CBottomWallTex::~CBottomWallTex(void)
{
...
Engine::CResources* Engine::CBottomWallTex::Clone(void)
{
	return new CBottomWallTex(*this);
}
...
void Engine::CBottomWallTex::Free(void)
{
	CVIBuffer::Free();
