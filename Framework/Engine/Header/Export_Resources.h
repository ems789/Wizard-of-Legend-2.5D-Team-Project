...
inline HRESULT	Ready_Buffer(LPDIRECT3DDEVICE9 pGraphicDev, const _ushort& wContainerIdx, const _tchar* pBufferTag, BUFFERID eID, WALLTYPE eVertexDir = WALL_OUTER, const D3DXCOLOR d3dColor = D3DXCOLOR(1.f, 1.f, 1.f, 1.f), const _tchar* pPath = L"", const _ulong dwCntX = 129, const _ulong dwCntZ = 129, const _ulong dwVtxItv = 1);
