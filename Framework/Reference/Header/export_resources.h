...
inline HRESULT	Ready_Buffer(LPDIRECT3DDEVICE9 pGraphicDev, const _ushort& wContainerIdx, const _tchar* pBufferTag, BUFFERID eID, const _ulong dwCntX = 129, const _ulong dwCntZ = 129, const _ulong dwVtxItv = 1);
